package www.cs.berkeley.edu.jrs.cs61b.lab.lab3;/* SList.java */
...
public class SList {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("In the main() method, construct a list that looks like:");
        System.out.println("[ 6 9 12 ]");

        SList sList = new SList();
        sList.insertFront(new SListNode(12));
        sList.insertFront(new SListNode(9));
        sList.insertFront(new SListNode(6));
        System.out.println(sList.toString());

        System.out.println("Add more lines to change this list to:");
